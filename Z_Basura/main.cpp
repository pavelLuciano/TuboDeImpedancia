...
int _main()
{
    GLFWwindow* miVentana = initDepsAndCreateWin();
        ...
        if (!isInputDeviceSelected)
        {
            ...
            if (device_selected_idx > -1)
            {
                ...
                if(ImGui::Button("Cargar dispositivo"))
                {
                    ...
                    std::ofstream l_signal_data("../med4dic/l_data"), 
                    r_signal_data("../med4dic/r_data"), 
                    l_signal_HI("../med4dic/l_HI"), 
                    r_signal_HI("../med4dic/r_HI"), 
                    l_signal_HII("../med4dic/l_HII"),
                    r_signal_HII("../med4dic/r_HII");

                    data->l_signal = &l_signal_data;
                    data->r_signal = &r_signal_data;
                    HI_data->l_signal = &l_signal_HI;
                    HI_data->r_signal = &r_signal_HI;
                    HII_data->l_signal = &l_signal_HII;
                    HII_data->r_signal = &r_signal_HII;
                } 
            }
            ImGui::End();
        }
